...
import info.samratcliff.utils.WrapLayout;
...
public abstract class QPace4_Imp implements circuitsearchengine, Observer {
    ...
    protected static final String filename = "/tmp/ecparams.params";
     ...
     *
     * @see
     * info.samratcliff.core.CircuitEvolution.circuitsearchengine#setAvailableinstructions(boolean
     * [])
     */
     ...
     *
     * @see
     * info.samratcliff.core.CircuitEvolution.circuitsearchengine#addObserver(java.util.Observer)
     */
    @Override
     ...
     * (non-Javadoc)
	 * 
	 * @see info.samratcliff.core.CircuitEvolution.circuitsearchengine#getAvailableinstructions()
	 */
     ...
     * (non-Javadoc)
     *
     * @see info.samratcliff.core.CircuitEvolution.circuitsearchengine#getCbuilder()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see info.samratcliff.core.CircuitEvolution.circuitsearchengine#getCevaluator()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see info.samratcliff.core.CircuitEvolution.circuitsearchengine#getName()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see info.samratcliff.core.CircuitEvolution.circuitsearchengine#getProgressBar()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see info.samratcliff.core.CircuitEvolution.circuitsearchengine#getSearchStatisticsPanel()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see info.samratcliff.core.CircuitEvolution.circuitsearchengine#statsDialog()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see info.samratcliff.core.CircuitEvolution.circuitsearchengine#removeAllObservers()
     */
    @Override
     ...
     *
     * @see
     * info.samratcliff.core.CircuitEvolution.circuitsearchengine#removeObserver(java.util.Observer
     * )
     */
    @Override
