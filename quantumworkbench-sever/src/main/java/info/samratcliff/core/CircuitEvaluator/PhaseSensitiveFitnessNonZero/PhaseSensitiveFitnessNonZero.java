...
public class PhaseSensitiveFitnessNonZero implements SuitabilityMeasure {
    /**
     *
     */
    ...
    public static void main(String[] args) {
        PhaseSensitiveFitnessNonZero test = new PhaseSensitiveFitnessNonZero(
                "PPSF");
     ...
     *
     */
    public PhaseSensitiveFitnessNonZero(String n) {
        name = n;
    }
