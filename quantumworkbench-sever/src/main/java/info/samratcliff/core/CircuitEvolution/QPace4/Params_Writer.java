...
import info.samratcliff.core.CircuitEvolution.QPace4.terminal.Instruction;
...
public class Params_Writer {
    ...
    private static final String parent_line = "parent.0 = "
            + Params_Writer.class.getClassLoader().getResource("QPACE4/basic_functionset.params").getPath();
    ...
    public void updateParams(boolean phase, boolean[] avail_gates, int gen,
        ...
        try {
            ...
            try (BufferedWriter osw = new BufferedWriter(new FileWriter(file.getAbsoluteFile()));) {
                System.out.println("Writing parameters to " + fname);
